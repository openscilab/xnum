...
def test_identity_conversion():
    assert convert("੦੧੨੩੪੫੬੭੮੯", source=NumeralSystem.GURMUKHI, target=NumeralSystem.GURMUKHI) == "੦੧੨੩੪੫੬੭੮੯"


def test_gurmukhi_to_english1():
    assert convert("੦੧੨੩੪੫੬੭੮੯", source=NumeralSystem.GURMUKHI, target=NumeralSystem.ENGLISH) == "0123456789"
...
def test_gurmukhi_to_persian1():
    assert convert("੦੧੨੩੪੫੬੭੮੯", source=NumeralSystem.GURMUKHI, target=NumeralSystem.PERSIAN) == "۰۱۲۳۴۵۶۷۸۹"
...
def test_gurmukhi_to_hindi1():
    assert convert("੦੧੨੩੪੫੬੭੮੯", source=NumeralSystem.GURMUKHI, target=NumeralSystem.HINDI) == "०१२३४५६७८९"
...
def test_gurmukhi_to_arabic_indic1():
    assert convert("੦੧੨੩੪੫੬੭੮੯", source=NumeralSystem.GURMUKHI, target=NumeralSystem.ARABIC_INDIC) == "٠١٢٣٤٥٦٧٨٩"
...
def test_gurmukhi_to_bengali1():
    assert convert("੦੧੨੩੪੫੬੭੮੯", source=NumeralSystem.GURMUKHI, target=NumeralSystem.BENGALI) == "০১২৩৪৫৬৭৮৯"
...
def test_gurmukhi_to_thai1():
    assert convert("੦੧੨੩੪੫੬੭੮੯", source=NumeralSystem.GURMUKHI, target=NumeralSystem.THAI) == "๐๑๒๓๔๕๖๗๘๙"
...
def test_gurmukhi_to_khmer1():
    assert convert("੦੧੨੩੪੫੬੭੮੯", source=NumeralSystem.GURMUKHI, target=NumeralSystem.KHMER) == "០១២៣៤៥៦៧៨៩"
...
def test_gurmukhi_to_burmese1():
    assert convert("੦੧੨੩੪੫੬੭੮੯", source=NumeralSystem.GURMUKHI, target=NumeralSystem.BURMESE) == "၀၁၂၃၄၅၆၇၈၉"
...
def test_gurmukhi_to_tibetan1():
    assert convert("੦੧੨੩੪੫੬੭੮੯", source=NumeralSystem.GURMUKHI, target=NumeralSystem.TIBETAN) == "༠༡༢༣༤༥༦༧༨༩"
...
def test_gurmukhi_to_gujarati1():
    assert convert("੦੧੨੩੪੫੬੭੮੯", source=NumeralSystem.GURMUKHI, target=NumeralSystem.GUJARATI) == "૦૧૨૩૪૫૬૭૮૯"
...
def test_gurmukhi_to_odia1():
    assert convert("੦੧੨੩੪੫੬੭੮੯", source=NumeralSystem.GURMUKHI, target=NumeralSystem.ODIA) == "୦୧୨୩୪୫୬୭୮୯"
