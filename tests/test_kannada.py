...
def test_identity_conversion():
    assert convert("೦೧೨೩೪೫೬೭೮೯", source=NumeralSystem.KANNADA, target=NumeralSystem.KANNADA) == "೦೧೨೩೪೫೬೭೮೯"


def test_Kannada_to_english1():
    assert convert("೦೧೨೩೪೫೬೭೮೯", source=NumeralSystem.KANNADA, target=NumeralSystem.ENGLISH) == "0123456789"
...
def test_Kannada_to_hindi1():
    assert convert("೦೧೨೩೪೫೬೭೮೯", source=NumeralSystem.KANNADA, target=NumeralSystem.HINDI) == "०१२३४५६७८९"
...
def test_Kannada_to_arabic_indic1():
    assert convert("೦೧೨೩೪೫೬೭೮೯", source=NumeralSystem.KANNADA, target=NumeralSystem.ARABIC_INDIC) == "٠١٢٣٤٥٦٧٨٩"
...
def test_Kannada_to_bengali1():
    assert convert("೦೧೨೩೪೫೬೭೮೯", source=NumeralSystem.KANNADA, target=NumeralSystem.BENGALI) == "০১২৩৪৫৬৭৮৯"
...
def test_Kannada_to_thai1():
    assert convert("೦೧೨೩೪೫೬೭೮೯", source=NumeralSystem.KANNADA, target=NumeralSystem.THAI) == "๐๑๒๓๔๕๖๗๘๙"
...
def test_Kannada_to_khmer1():
    assert convert("೦೧೨೩೪೫೬೭೮೯", source=NumeralSystem.KANNADA, target=NumeralSystem.KHMER) == "០១២៣៤៥៦៧៨៩"
...
def test_Kannada_to_burmese1():
    assert convert("೦೧೨೩೪೫೬೭೮೯", source=NumeralSystem.KANNADA, target=NumeralSystem.BURMESE) == "၀၁၂၃၄၅၆၇၈၉"
...
def test_Kannada_to_persian1():
    assert convert("೦೧೨೩೪೫೬೭೮೯", source=NumeralSystem.KANNADA, target=NumeralSystem.PERSIAN) == "۰۱۲۳۴۵۶۷۸۹"
...
def test_Kannada_to_gujarati1():
    assert convert("೦೧೨೩೪೫೬೭೮೯", source=NumeralSystem.KANNADA, target=NumeralSystem.GUJARATI) == "૦૧૨૩૪૫૬૭૮૯"
