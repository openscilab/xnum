...
def test_hindi_to_english2():
    assert convert("abc ०१२३४५६७८९ abc", source=NumeralSystem.HINDI, target=NumeralSystem.ENGLISH) == "abc 0123456789 abc"
...
def test_hindi_to_persian2():
    assert convert("abc ०१२३४५६７८९ abc", source=NumeralSystem.HINDI, target=NumeralSystem.PERSIAN) == "abc ۰۱۲۳۴۵۶۷۸۹ abc"
...
def test_hindi_to_arabic_indic2():
    assert convert("abc ०१२३४५६７८९ abc", source=NumeralSystem.HINDI, target=NumeralSystem.ARABIC_INDIC) == "abc ٠١٢٣٤٥٦٧٨٩ abc"
...
def test_hindi_to_bengali2():
    assert convert("abc ०१२३४५६७८९ abc", source=NumeralSystem.HINDI, target=NumeralSystem.BENGALI) == "abc ০১২৩৪৫৬৭৮৯ abc"